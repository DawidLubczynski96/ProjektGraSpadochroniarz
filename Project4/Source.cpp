...
void InitTlo(Tlo &tyl, float x, float y, float velx, float vely, int width, int height, int dirX, int dirY, ALLEGRO_BITMAP *image);
...
int main(void)
{
	...
	al_destroy_bitmap(tlo2Image);
	al_destroy_bitmap(tlo1Image);
	al_destroy_bitmap(tloImage);
